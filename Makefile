...
help:
	...
	@echo "  make test PATTERN=delete                # Match test/**/*delete*_spec.lua"
...
#   make test PATTERN=delete  (shorthand for test/**/*delete*_spec.lua)
test: install-deps
...
clean:
	...
	@rm -rf test/*.out
	@rm -rf *.swp
	@rm -rf /tmp/bufdel_nvim_test_* 2>/dev/null || true
